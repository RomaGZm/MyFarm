...
namespace Core.UI
{
    public class Popup : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            Vector3 newPos = new Vector3(target.position.x, target.position.y + currentValue, target.position.z);

            transform.position = new Vector3(newPos.x + rondom_.x, newPos.y + rondom_.y, 0); 
        }
        private IEnumerator Disable(float waitSec)
        {
        ...
        /// <summary>
        /// Show text popup animation
        /// </summary>
        /// <param name="target"></param>
        /// <param name="text"></param>
        /// <param name="direction"></param>
        /// <param name="textColor"></param>
        /// <param name="randomMinValues"></param>
        /// <param name="randomMaxValues"></param>
